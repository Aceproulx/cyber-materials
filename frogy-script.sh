...
##############################################
RUN_DIR="frogy-output/run-$(date +%Y%m%d%H%M%S)"
...
run_colleague_identification() {
	...
	local keywords_file="$HOME/frogy2.0/colleague_keywords.txt"
...
build_html_report() {
	...
	cat $HOME/frogy2.0/header.html >report.html
	...
	cat $HOME/frogy2.0/footer.html >>report.html
	...
	cp $HOME/frogy2.0/assets/report.css "$RUN_DIR/assets/report.css"
